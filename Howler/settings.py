...
AWS_ACCESS_KEY_ID = os.environ.get('AKIAIKTDGHJFFOPMZPUQ')
AWS_SECRET_ACCESS_KEY = os.environ.get('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')
AWS_STORAGE_BUCKET_NAME = 'howlerse'
